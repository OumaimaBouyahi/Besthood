...
module.exports = {
  ...
  google: {
    clientID: process.env.GOOGLE_ID || '203291022908-upgsjq3dfvl6aniqp6e70aq196c9d43v.apps.googleusercontent.com',
    clientSecret: process.env.GOOGLE_SECRET || 'or2lV2zJKGvys5QRkzf7kgdA',
  ...
  seedDB: {
    ...
    options: {
      ...
      seedAdmin: {
        username: process.env.MONGO_SEED_ADMIN_USERNAME || 'ebdelli',
        provider: 'facebook',
        email: process.env.MONGO_SEED_ADMIN_EMAIL || 'khlech2008@gmail.com',
        firstName: 'khaled',
        lastName: 'ebdelli',
        displayName: 'khaled ebdelli',
        roles: ['user', 'admin']
      }
    }
  }
